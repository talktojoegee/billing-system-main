...
<div class="container">
    ...
    <table style="">
        ...
        <tr><td class="bold">Paid At:</td><td>{{$pay_mode}} // Receipt No: {{$receipt_no}} // Invoice No: <span style="text-transform: uppercase;">{{$assessmentNo}}</span> <br>Swift Code: <span style="text-transform: uppercase;">{{$swift_code}}</span> // Paid Date:
            {{$payment_date}}</td></tr>
        <tr><td class="bold">Agency:</td><td>BUREAU OF LANDS</td></tr>
